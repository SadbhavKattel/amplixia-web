      ...
      <div className="container">
        <div className="footer-top">
          <div className="footer-brand">
            <Link href="/" className="logo" aria-label="Amplixia">
          ...
          <div className="footer-cols">
            <div className="footer-col">
              <h4>Services</h4>
              <ul>
                <li><Link href="/#services">Brand Websites</Link></li>
                <li><Link href="/#services">AI Tutoring</Link></li>
            ...
            <div className="footer-col">
              ...
              <ul>
                ...
                <li><Link href="/#insights">Notes</Link></li>
              </ul>
            </div>
            <div className="footer-col">
              <h4>Connect</h4>
              <ul>
                <li><a href="mailto:services@amplixia.com">services@amplixia.com</a></li>
        ...
        <div className="footer-bottom">
          <span>© {new Date().getFullYear()} Amplixia Private Limited. All rights reserved.</span>
